...
namespace MultiTenant_Inventory_Management.Migrations
{
    ...
    [Migration("20220924125038_AllUpdates")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MultiTenant_Inventory_Management.Models.Inventory.TenantAndUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("AcceptInvite")
                        .HasColumnType("bit");

                    b.Property<DateTime>("DateOfIntegration")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DateOfInvite")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("IsIntegrationActive")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MultiTenant_Inventory_Management.Areas.Identity.Data.SaasUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MultiTenant_Inventory_Management.Models.Inventory.TenantAndUser", b =>
                {
                    b.HasOne("MultiTenant_Inventory_Management.Areas.Identity.Data.SaasUser", "AccessProvider")
                        .WithMany()
